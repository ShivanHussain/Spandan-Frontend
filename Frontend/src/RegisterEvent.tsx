...
<<<<<<< HEAD
  ...
  const submitlogout = async () => {
    try {
      const res = await axios.post("https://spandan-backend-s1d2.onrender.com/api/v2/user/logout",
        {},
...
<<<<<<< HEAD
    ...
    if (eventName === "solo-dance" || eventName === "magic-of-voice" ||
      ...
      try {
        ...
        const res = await axios.post(`https://spandan-backend-s1d2.onrender.com/api/v2/solo/participate/${id}`,
      ...
      try {
        ...
        const res = await axios.post(`https://spandan-backend-s1d2.onrender.com/api/v2/group/participate/${id}`,
          submissionData, { withCredentials: true });
